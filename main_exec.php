...
switch ($_REQUEST['exec'])
{
	...
	case "insert_comment_info" :
		...
		$query 		= "INSERT INTO ".$_gl['comment_info_table']."(consumer_seq, content, image1, image2, image3, ip_address, link1, link2, link3, livere_seq, member_domain, member_group_seq, member_icon, member_id, member_seq, member_url, member_name, parent_seq, rep_seq, reply_seq, site, agent, member_title, reply_regdate, status, sept_sns, info1, info2, info3) values('".$consumer_seq."','".$content."','".$image1."','".$image2."','".$image3."','".$ip_address."','".$link1."','".$link2."','".$link3."','".$livere_seq."','".$member_domain."','".$member_group_seq."','".$member_icon."','".$member_id."','".$member_seq."','".$member_url."','".$member_name."','".$parent_seq."','".$rep_seq."','".$reply_seq."','".$site."','".$agent."','".$member_title."','".$reply_regdate."','".$status."','".$septSNSObj."','".$info1."','".$info2."','".$info3."')";
		$result 	= mysqli_query($my_db, $query);
